...
# player.bmp, kid.bmp, mrs_brown.bmp — generated by tools/lpc_to_gba.py (LPC pipeline)
# Do NOT regenerate them here; run lpc_to_gba.py with the source layers instead.

# NPC 1 — green shirt, brown hair (generic overworld NPC)
...
# NPC 2 — gold/merchant look (generic overworld NPC)
